...
walls.register = function(wall_name, wall_desc, wall_texture, wall_mat, wall_sounds)
	...
	minetest.register_node(wall_name, {
		...
		connects_to = { "group:wall", "group:stone", "group:cracky" },
		paramtype = "light",
...
minetest.register_alias("default:wall_cobble", "walls:cobble")
minetest.register_alias("default:wall_mossycobble", "walls:mossycobble")
